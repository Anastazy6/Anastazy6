  ...
  return (
    <>
      ...
      >
        ...
        since I wanted to practice it a bit. Uses localStorage for persistent
        data storage - it is limited to a single computer and a single browser.
        At the time of writing this only desktop/laptop screen widths are supported.
      </article> 
